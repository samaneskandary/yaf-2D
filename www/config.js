...
const GOAL_W = 165;        // دهانه‌ی کمی باریک‌تر → گل‌زدن کمی سخت‌تر
...
const MIN_PULL  = 14;
const FRICTION  = 0.97;  // اصطکاک هر فریم (پیش‌فرض)
...
const FRICTION_BY_LEVEL = {1:0.955, 2:0.965, 3:0.975};
...
const REST_WALL = 0.77;   // جهندگی دیوار (۰٫۸۶→۰٫۷۲) — توپ کنارِ دیواره‌ها پینگ‌پنگ نمی‌کند
const WIN_GOALS = 3;
